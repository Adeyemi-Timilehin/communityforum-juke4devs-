        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-dark" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    <a class="bg-dark  primary list-group-item list-group-item-action list-group-item-light p-3" href="{{ route('homepage') }}"><span class="fa fa-home"></span> Home</a>
                    <a class="bg-dark primary list-group-item list-group-item-action list-group-item-light p-3" href="{{ route('signup') }}"><span class="fa fa-pen"></span> Write Something</a>
